...
$query_data = "SELECT tempL,tempR,timestamp FROM `measured_data`.`measured_data` WHERE account_id='".$user_id."';";
...
while($row_data = $result_data->fetch_assoc()){
	echo $row_data["tempL"].",".$row_data["tempR"].",".$row_data["timestamp"]."\xA";
}
